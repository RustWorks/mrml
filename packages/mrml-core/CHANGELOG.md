...
## [5.0.0](https://github.com/RustWorks/mrml/compare/mrml-v4.0.1...mrml-v5.0.0) - 2024-11-22

### Added

- *(mrml-core)* add x to the supported social elements ([#469](https://github.com/RustWorks/mrml/pull/469))
...
- *(mrml-core)* handle duplicate border in mj-column ([#479](https://github.com/RustWorks/mrml/pull/479))
- *(mj-core)* mj-text is an ending tag ([#478](https://github.com/RustWorks/mrml/pull/478))
- *(mrml-core)* comments in mrml component should be ignored ([#477](https://github.com/RustWorks/mrml/pull/477))

### Other

- *(deps)* bump htmlparser to 0.2.1 ([#489](https://github.com/RustWorks/mrml/pull/489))
- use package attributes from workspace ([#488](https://github.com/RustWorks/mrml/pull/488))
- change visibility of modules ([#487](https://github.com/RustWorks/mrml/pull/487))
- replace xmlparser by htmlparser ([#485](https://github.com/RustWorks/mrml/pull/485))
- *(mrml-core)* remove unwraps in code ([#482](https://github.com/RustWorks/mrml/pull/482))
- *(deps)* upgrade multiple dependencies ([#476](https://github.com/RustWorks/mrml/pull/476))
- *(mrml-core)* create alias for attributes map
- apply format changes
- rename json traits to json prefix
- stop returning impl ([#449](https://github.com/RustWorks/mrml/pull/449))
- *(mrml-core)* base all component on the same struct ([#448](https://github.com/RustWorks/mrml/pull/448))
- *(mrml-core)* introduce proper errors for size parsing ([#447](https://github.com/RustWorks/mrml/pull/447))
- remove to_owned call
- make size, pixel, percent copy ([#445](https://github.com/RustWorks/mrml/pull/445))
